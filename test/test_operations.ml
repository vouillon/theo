...
let test_utility () =
  ...
  let b1 = new_var Boolean in
  let b2 = new_var Boolean in
...
let test_logical_operations () =
  ...
  (* Test associativity *)
  let assoc1 = (e1 && e2) && atom (new_var Boolean) in
  let assoc2 = e1 && e2 && atom (new_var Boolean) in
...
let test_more_theory_simplification () =
  ...
  let a = new_var Version in
  let b = new_var String in
  let c = new_var Boolean in
...
let test_variable_ordering () =
  ...
  (* Case 1: Interleaved *)
  let a1 = new_var Boolean in
  let b1 = new_var Boolean in
  let a2 = new_var Boolean in
  let b2 = new_var Boolean in
